...
export const Features: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "We understand that every pipeline operation is different. Our solutions are designed to adapt to your specific needs, leveraging advanced technology to improve performance and overcome your biggest obstacles.",
    },
  ];
